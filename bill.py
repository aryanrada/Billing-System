...
class Bill_App:
    def __init__(self,root):
        ...
        bg_color = "#000000"
        title = Label(self.root, text="Store Billing System", bd=12, relief=GROOVE,
        ...
        total_btn = Button(btn_F,command=self.total,text="Total",bg="#96050C",fg="white",pady=3,width=10,bd = 3 , font="arial 12 bold").grid(row=0,column=0,padx=5,pady=5)
        ...
        Clear_btn = Button(btn_F, command=self.clear_data, text="Clear", bg="#96050C", fg="white", pady=3, width=9, bd=3,
                           font="arial 12 bold").grid(row=0, column=2, padx=1, pady=1)

        Exit_btn = Button(btn_F, command=self.Exit_app, text="Exit", bg="#96050C", fg="white", pady=3, width=9, bd=3,
